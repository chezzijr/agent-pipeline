...
- superseded-by: DEC-145 (its unconditional rule that `revalidating` keeps load-flaky as a failure makes the advertised recovery return to the same verdict., 2026-09-20)
